        ...
        <div className='container mt-3'>
            <div className="nav-scroller py-1 mb-2">
                <nav className="nav d-flex justify-content-between">
                    <Link className="p-2 text-muted" to='/category/cat1'>Cat1</Link>
                    <Link className="p-2 text-muted" to='/category/cat2'>Cat2</Link>
                    <Link className="p-2 text-muted" to='/category/cat3'>Cat3</Link>
                    <Link className="p-2 text-muted" to='/category/cat4'>Cat4</Link>
                </nav>
            </div>
